...
//  RMShapedImageView
//
//  Created by Ruben on 2/13/16.
//

import UIKit
import CoreGraphics

class RMShapedImageView: UIImageView {
    //public
    var shapedPixelTolerance: CGFloat = 0
    var shapedTransparentMaxAlpha: CGFloat = 0
