...
SWIFT_CLASS("_TtC17RMShapedImageView17RMShapedImageView")
@interface RMShapedImageView : UIImageView
@property (nonatomic) CGFloat shapedPixelTolerance;
@property (nonatomic) CGFloat shapedTransparentMaxAlpha;
